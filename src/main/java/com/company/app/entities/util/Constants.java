...
public class Constants {
    ...
    public final static int BANK_ACCOUNT_CURRENT_LENGTH = 20;
    public final static int VISA_CARD_NUMBER_LENGTH = 16;
    public final static int CARD_PASSWORD_LENGTH = 4;
    ...
    static {
        ...
        try {
            ...
            fis = new FileInputStream("src\\main\\resources\\strings.properties");
            property.load(fis);
